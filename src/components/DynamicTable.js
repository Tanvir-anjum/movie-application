...
// get table column
    const column = ["title","poster_path","overview","popularity","release_date"];
                ...
                <tr>
                    {
                        column.map((v)=>{
                             if (v=='poster_path'){
                               return <td><img src={'https://image.tmdb.org/t/p/original'+ data[v]} height={"100px"} alt={data['title']}/></td>
...
<>
    ...
    <div >
        <span><a onClick={loadPreviousData} style={{cursor : "pointer",padding : "10px",alignment : "center"}}> Previous</a></span>
